...
todos:
  - id: update-report
    content: Update Report.tsx to auto-select first cluster using useMemo
    status: completed
  - id: add-tests
    content: Add tests for auto-selection and cluster options ordering
    status: completed
  - id: create-pr
