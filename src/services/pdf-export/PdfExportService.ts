...
/**
 * Export blocks in dashboard order. Optional blocks (1 / 1a / 1b / 4a) are
...
/**
 * Split a capture segment across A4 pages so tall blocks stay readable
 * instead of being scaled to one page.
 */
