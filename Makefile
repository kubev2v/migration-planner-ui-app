...
MIGRATION_PLANNER_API_BASE_URL ?= /api/migration-assessment-dev
MIGRATION_PLANNER_COST_ESTIMATION_API_BASE_URL ?= /api/cost-estimation-dev
MIGRATION_PLANNER_UI_GIT_COMMIT ?= $(SOURCE_GIT_COMMIT)
MIGRATION_PLANNER_UI_VERSION ?= $(SOURCE_GIT_TAG)

BUILD_VAR_NAMES := MIGRATION_PLANNER_API_BASE_URL MIGRATION_PLANNER_COST_ESTIMATION_API_BASE_URL MIGRATION_PLANNER_UI_GIT_COMMIT MIGRATION_PLANNER_UI_VERSION
